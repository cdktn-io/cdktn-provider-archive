...
// https://registry.terraform.io/providers/hashicorp/archive/2.8.1/docs/data-sources/file
...
export class DataArchiveFile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataArchiveFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/archive/2.8.1/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
